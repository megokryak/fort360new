  ...
  document.addEventListener("DOMContentLoaded", function () {
    const swiper = new Swiper(".about__together-slider", {
      ...
      breakpoints: {
        ...
        1201: {
          slidesPerView: 5, // Для экранов меньше 768px показываем 4 слайда
          spaceBetween: 90, // Стандартные отступы
        },
        0: {
          slidesPerView: 4, // Для самых маленьких экранов тоже показываем 4 слайда
          spaceBetween: 32, // Стандартные отступы
        },
      },
    });
